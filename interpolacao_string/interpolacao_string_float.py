...
#formatação apenas como valo final
print("Valir 1: {:f}" .format(valor1))
...
#formatação float com separadores de milhares e decimal em 2 dígitos
print("Valor 2: {:,.2f}" .format(valor2))



#formatação float, com total de 10 dígitos (número e ponto), sendo 2 decimais
print("Valor 1 {:10.2f}" .format(valor1))
print("Valor 2 {:10.2f}" .format(valor2))
print("Valor 3 {:10.2f}" .format(valor3))

#semelhante ao anterio, mas preenche as casas antes do ponto, com zero, quando necessário
